...
from api.serializers import GetSuperUserSerializer, StartupsListSerializer,StartupsCreateSerializer, StartupStatusesSerializer, StartupFilesSerializer, StartupCommentSerializer, StartupCommentListSerializer, StartupReplySerializer, GetUser
...
class StartupCommentList(generics.ListAPIView):   
    serializer_class =  StartupCommentListSerializer
    model = Comments
    queryset = Comments.objects.all()
